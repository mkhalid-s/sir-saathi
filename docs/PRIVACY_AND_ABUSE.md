...
The official-assistance panel and API are outbound directories only. SIR Saathi does not accept, proxy, log, or store complaints, application details, callback requests, emails, or voter documents submitted to ECI or a CEO portal.
