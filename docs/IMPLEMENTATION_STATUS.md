...
| Accessibility | The generated-page structural audit covers every public page and currently reports zero findings. A value-redacting, fail-closed evidence template/validator governs 11 manual checks, four required environment combinations, publishable-locale coverage, remediation, and retest records. Keyboard, live-region, RTL, forced-colour, reduced-motion, reflow, zoom, and assistive-technology review must still be performed by a named human on the deployed build. |
...
The review snapshot passes 277 tests, reports zero npm vulnerabilities, verifies 140 governed source records as fresh, precaches 55 generated offline assets, and reports zero automated accessibility or discoverability findings across 40 indexable English pages plus the no-index error page.
