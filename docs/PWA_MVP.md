...
- A public, localized language-availability page enumerates all 17 governed codes and directions, distinguishes publishable, planned, and blocked activation states, and explains the independent human-review boundary without exposing draft copy or reviewer identities. The API exposes the same safe readiness facts.
