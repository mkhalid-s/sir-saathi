...
- Safe "Find my name" entry flow that routes users to official search first, does not call indexed public search in the MVP fallback, and lets users clear local hints.
